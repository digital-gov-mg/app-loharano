...
export default class AssignList extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            notebook_number:'',
    ...
    householdDetails(index){
        const data = {};
        Object.assign(data, {household: this.state.households[index]});
        this.props.navigation.navigate('AssignHouseholdDetails', {data: data});
    }
        ...
        return (
            <View style={mainStylesheet.container_secondary}>
                ...
                <ScrollView style={{marginVertical: 15}}>
                    ...
                    <TouchableOpacity key={index} onPress={() => this.householdDetails(index)}>
                    <View style={mainStylesheet.listItemCitizen}>
                        <View>
